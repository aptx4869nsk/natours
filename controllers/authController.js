...
const createSendToken = (user, statusCode, req, res) => {
  ...
  // Remove the password from outputs
...
exports.login = catchAsync(async (req, res, next) => {
  ...
  // .select('+password') >>>> because select:false is set in userModel, to show the password in model we have to use .select('+password')
...
exports.updatePasswod = catchAsync(async (req, res, next) => {
